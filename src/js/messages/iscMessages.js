      ...
      $stateProvider
        .state('index.messages', {
          ...
          resolve: {
            ...
            showWarning: function( iscMessagesModel, unreadMessages ){
              iscMessagesModel.setShowEmergencyWarning( true );
            },

            loadSecondaryNav: function( $log, showWarning, iscCustomConfigService, iscNavContainerModel ){
        ...
        .state('index.messages.inbox', {
          ...
          resolve: {
            messageData: function( $log, loadSecondaryNav, iscMessagesApi ){
              ...
              return iscMessagesApi.inbox().then( function( data ){
                return data;
              });
            },
