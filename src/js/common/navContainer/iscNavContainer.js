          ...
          .state('index', {
            ...
            resolve: {
              loadConfig: function(  $log, iscCustomConfigService ){
                //$log.debug( 'common/iscNavContainer.loadConfig');
...
//        $locationProvider.html5Mode(true);
    ...
    .run( ['$log', '$rootScope', '$state', '$window', 'iscSessionModel', 'iscCustomConfigService', 'iscCustomConfigHelper','iscSessionStorageHelper', 'AUTH_EVENTS',
      function( $log, $rootScope, $state, $window, iscSessionModel, iscCustomConfigService, iscCustomConfigHelper, iscSessionStorageHelper, AUTH_EVENTS ){
