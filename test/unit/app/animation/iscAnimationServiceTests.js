...
(function(){
  ...
  describe('iscAnimationService', function(){
    ...
    describe( 'getSideNavHeight tests ', function(){
      ...
      it( 'should get the nav height', function(){
        $window.innerWidth = 960;
        $window.innerHeight = 1000;

        var result = service.getSideNavHeight( 500 ); //400
        expect( result ).toBe( 500 );

        $window.innerWidth = 480;

        var result = service.getSideNavHeight();
    ...
    describe( 'getSecondaryNavHeight tests ', function(){
      ...
      it( 'should get the nav height', function(){
        ...
        var result = service.getSecondaryNavHeight( 500 ); //400
        expect( result ).toBe( 600 );

        $window.innerWidth = 480;

        var result = service.getSecondaryNavHeight();
        expect( result ).toBe( 1000 );
      });
    });
